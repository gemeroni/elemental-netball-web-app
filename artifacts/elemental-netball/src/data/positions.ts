...
export const POSITIONS: Position[] = [
  ...
  },
  {
    ...
    note: "GA is one of only two players who can shoot for goal. They cover more ground than GS, running from the centre all the way to the circle.",
    matchup: "GD",
    matchupDescription:
  ...
  },
  {
    ...
    note: "GD covers the most ground of any defender, running from the transverse line all the way back to the shooting circle.",
    matchup: "GA",
    matchupDescription:
